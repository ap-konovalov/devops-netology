...
AWS предоставляет достаточно много бесплатных ресурсов в первый год после регистрации, подробно
описано [здесь](https://aws.amazon.com/free/).
...
2. Зарегистрируйте провайдер
    1. для [aws](https://registry.terraform.io/providers/hashicorp/aws/latest/docs). В файл `main.tf` добавьте
       ...
       выбранный вами регион внутри блока `provider`.
...
***
Cоздать образ можно при помощи packer.

2. Ссылку на репозиторий с исходной конфигурацией терраформа.
***
[Конфигурация terraform](07-terraform-02-syntax/main.tf).